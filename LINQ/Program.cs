...
namespace LINQ
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Odgovor 1A: {vsota}");
            Console.WriteLine();
            Console.WriteLine("Odgovor 1B");
            ...
            {
                Console.WriteLine($"Ostanek {ostanek.Key}:");
            ...
            Console.WriteLine("Odgovor 2A:");
            Console.WriteLine(skupenNiz);
            Console.WriteLine();
            Console.WriteLine("Odgorvor 2B");
