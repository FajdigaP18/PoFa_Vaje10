...
namespace BloomFilter
{
    internal class Program
    {
        ...
        */
        ...
        // Definiramo objekt: 
        private static IBloomFilter bloomFilter = FilterBuilder.Build(100, 0.8);
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Check if 'www.facebook.com' is spam URL: {bloomFilter.Contains("www.facebook.com")}");
            ...
            Console.WriteLine($"Check if 'fix-computer.net' is spam URL: {bloomFilter.Contains("excel-password-recovery.net")}");
            Console.WriteLine($"Check if 'abcd.com' is spam URL: {bloomFilter.Contains("Programiranje.com")}");
        }
